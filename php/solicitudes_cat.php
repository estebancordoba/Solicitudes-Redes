<?php
  ...
  if ($_POST['categoria']=='1') {
    $sql= "select * from solicitudes where tipoSol
          like 'Permisos especiales de navegacion  o solicitud de IP publica'";
  }
  else if ($_POST['categoria']=='2') {
    $sql= "select * from solicitudes where tipoSol
          like 'Registro de un nuevo equipo a la red'";
  }
  else if ($_POST['categoria']=='3') {
    $sql= "select * from solicitudes where tipoSol
          like 'Instalacion de un punto de red'";
  }
  else if ($_POST['categoria']=='4') {
    $sql= "select * from solicitudes where tipoSol
          like 'Solicitud de una videoconferencia o videollamada'";
  }
